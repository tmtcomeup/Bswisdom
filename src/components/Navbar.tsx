...
import { Brain, Menu, X, ShoppingCart, ChevronDown, Heart, Book } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 w-64 bg-white rounded-lg shadow-xl py-2 mt-1 hidden group-hover:block z-50">
            ...
            >
              ...
              {cartItemCount > 0 && (
                <span className="bg-secondary-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                  {cartItemCount}
                </span>
              )}
            </Link>
