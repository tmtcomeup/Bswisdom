...
const CareerCoachingPage: React.FC = () => {
  ...
  const relatedGuides = [
    {
      ...
      path: '../guides/career-advancement',
    },
    {
  ...
  return (
    <ResourceLayout
      title="Career Coaching and Advancement"
      description="Expert guidance for career planning, professional development, and advancement strategies."
    >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Get expert help with your career planning and advancement.
              </p>
              <Link
                to="/contact"
