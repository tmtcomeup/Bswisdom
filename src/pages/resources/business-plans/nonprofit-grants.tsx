...
const NonprofitGrantsPage: React.FC = () => {
  const topics = [
    {
      title: 'Grant Planning',
      items: [
        'Needs Assessment',
        'Program Design',
        'Budget Development',
      ...
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-200 pb-8">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Nonprofit Grants</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl">
            Expert guidance for nonprofit grant writing and management.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Get expert assistance with nonprofit grants.
              </p>
              <Link
                to="/contact"
...
export default NonprofitGrantsPage;
