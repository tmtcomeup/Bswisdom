...
const BookMarketingPage: React.FC = () => {
  const topics = [
    {
      ...
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-200 pb-8">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Book Marketing</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl">
            Effective strategies and tools for marketing your ebook and reaching your target audience.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Get expert help marketing your ebook effectively.
              </p>
              <Link
                to="/contact"
