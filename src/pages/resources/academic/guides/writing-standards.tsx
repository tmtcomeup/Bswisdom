...
const WritingStandardsGuide: React.FC = () => {
  const topics = [
    {
      ...
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-200 pb-8">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Writing Standards</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl">
            Guide to academic writing standards and best practices.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Get expert assistance with academic writing.
              </p>
              <Link
                to="/contact"
...
export default WritingStandardsGuide;
