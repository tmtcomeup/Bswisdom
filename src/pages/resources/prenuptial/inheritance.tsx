...
import { GiftIcon, ArrowRight, BookOpen } from 'lucide-react';
...
const InheritancePage: React.FC = () => {
  ...
  const relatedGuides = [
    {
      ...
      description: 'Integrating prenups with estate plans',
      path: '../guides/estate-planning',
    },
    {
      title: 'Fair Agreement Guide',
      description: 'Balancing inheritance rights',
  ...
  return (
    <ResourceLayout
      title="Prenuptial Agreements and Inheritance"
      description="Expert guidance on protecting inheritance rights and integrating estate planning in prenuptial agreements."
    >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Get expert help protecting your inheritance rights.
              </p>
              <Link
                to="/contact"
