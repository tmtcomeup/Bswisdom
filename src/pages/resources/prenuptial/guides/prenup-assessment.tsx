...
const PrenupAssessmentGuidePage: React.FC = () => {
  const topics = [
    {
      title: 'Pros of Prenuptial Agreements',
      items: [
        'Asset Protection',
  ...
  const practicalTips = [
    'Have open financial discussions',
      ...
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-200 pb-8">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Is a Prenuptial Agreement Right for You?</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl">
            A balanced perspective on the benefits, concerns, and alternatives to prenuptial agreements.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-50 rounded-xl p-6">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Our team of legal experts is ready to help you decide if a prenuptial agreement is right for you.
              </p>
              <Link
                to="/contact"
...
export default PrenupAssessmentGuidePage;